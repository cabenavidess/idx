...
class User extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface
{
    ...
    public function fields()
    {
	    ...
	    if($this->role == self::ROLE_STAFF || $this->role == self::ROLE_ADMIN || $this->role == self::ROLE_USER) {
    ...
    {
        // $this->auth_key = Yii::$app->security->generateRandomString($length = 8 );
        $length = 80;
        ...
        $generateRamdomString = implode(array_slice($chars, 0, $length));

        $this->auth_key = $generateRamdomString;
    }
    /**
