...
class m170125_082006_create_user_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->batchInsert('user', ['id', 'username', 'auth_key', 'access_token_expired_at', 'password_hash', 'password_reset_token', 'email', 'unconfirmed_email', 'confirmed_at', 'registration_ip', 'last_login_at', 'last_login_ip', 'blocked_at', 'status', 'role', 'created_at', 'updated_at'], [
	        [1, 'admin', 'dVN8fzR_KzJ_lBrymfXI6qyH2QzyXYUU', '2017-06-04 00:13:29', '$2y$13$9Gouh1ZbewVEh4bQIGsifOs8/RWW/7RIs0CAGNd7tapXFm9.WxiXS', NULL, 'admin@induxionecuador.com', 'admin@induxionecuador.com', '2017-05-05 16:38:48', '127.0.0.1', '2017-06-03 00:13:29', '127.0.0.1', NULL, 10, 99, '2017-05-05 16:38:03', '2017-06-03 00:13:26'],
			[3, 'user', 'rNXSqIas_43RdpG0e5_7d1W06iK8pXJ8', '2017-06-04 00:13:02', '$2y$13$nd/F3g6jjIa1/Sk6JZxZ5uVq0OpsbOmW1OdnbDG6BpFqgkFbQotjm', NULL, 'user@induxionecuador.com', 'user@induxionecuador.com', '2017-06-03 00:12:16', '127.0.0.1', '2017-06-03 00:13:02', '127.0.0.1', NULL, 10, 10, '2017-05-21 23:31:53', '2017-06-03 13:34:52'],
        ]);
    }
